    ...
    <StoreLayout>
      {() => (
        <section className="container py-10 md:py-14">
          <Link to="/marcas" className="mb-6 inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-accent transition-colors">
          ...
          <div className="grid place-items-center rounded-3xl border-2 border-dashed border-border bg-secondary/30 py-24 text-center">
            ...
            <p className="mt-1 max-w-sm text-sm text-muted-foreground">
              Esta sección aún no está disponible. Ve a Productos para ver todo nuestro catálogo.
            </p>
